<?php
    $currentPage = 'VaccineType';
    include('common/header.php');
?>
        <!-- Page Content -->
        <div id="content">
            <?php require_once 'processVaccineType.php'; ?>
            <?php
                ...
                <table class="table table-sm">
                    ...
                    <?php while ($row = $result->fetch_assoc()) : ?>
                        <tr>
                            ...
                            <td>
                                <a href="vaccineType.php?edit=<?php echo $row['name']; ?>" class="btn btn-info"> Edit </a>
                                <a href="processVaccineType.php?delete=<?php echo $row['name']; ?>" class="btn btn-danger"> Delete </a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </table>
